...
import { CREATE_QUOTATION_REQUEST, UPDATE_QUOTATION_REQUEST } from '@/modules/quotations/types'
...
function EditQuotation({ user: initialUser,
}: {
    user: {
        name: string
        email: string
                                                            ...
                                                            <FormItem>
                                                                <Select
                                                                    onValueChange={(val) => {
                                                                        ...
                                                                        form.setValue(`items.${index}.item_id`, idMap[val] || 0)
                                                                    }}
                                                                    value={field.value}
                                                                >
                                                                    <FormControl>
