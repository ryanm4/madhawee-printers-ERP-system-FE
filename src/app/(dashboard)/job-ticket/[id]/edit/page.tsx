            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    form.reset({
                        ...
                        remarks: jt.remarks,
                        oldPlatesQuantity: (jt as any).old_plates_quantity,
                        oldPlatesStatus: (jt as any).old_plates_status,
                        oldPlatesRemarks: (jt as any).old_plates_remarks,
                        newPlatesQuantity: (jt as any).new_plates_quantity,
                        newPlatesStatus: (jt as any).new_plates_status,
                        newPlatesRemarks: (jt as any).new_plates_remarks,
                        rawMaterials: (jt as any).raw_materials?.map((rm: any) => ({
                            item: rm.item,
