...
import { COATING_TYPES, INK_STATUS, PLATES_STATUS, PRODUCT_TYPES } from "@/config/enum"
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    form.reset({
                        ...
                        orderReceivedDate: (jt as any).order_received_date ? new Date((jt as any).order_received_date) : undefined,
                        jobNumber: (jt as any).job_number || String(jt.job_id),
                        jobOpenDate: jt.job_open_date ? new Date(jt.job_open_date) : undefined,
                        ...
                        wastage: jt.wastage,
                        packingDate: jt.packing_date ? new Date(jt.packing_date) : undefined,
                        ...
                        })) || [{ paper: "", coating: "", delivery_date: new Date(), rawMaterials: [{ item_id: undefined, material_name: "", material_type: "", size: "", material_description: "", quantity: 0, status: "", remarks: "" }] }],
                    });
                }
            } catch (error) {
                            ...
                            <div>
                                                        ...
                                                        <PaperTypeCombobox
                                                            ...
                                                            onChange={(val) => {
                                                                ...
                                                                if (val) {
                                                                    ...
                                                                    if (selectedPaper) {
                                                                        const rawMaterialsData = form.getValues(`paperTypes.${index}.rawMaterials`);
                                                                        rawMaterialsData?.forEach((_, rmIndex) => {
                                ...
                                <div className="flex justify-end mt-2">
                                    <Button
                                        type="button"
                                        onClick={() => {
                                            appendPaperType({ paper: "", coating: "", delivery_date: undefined, rawMaterials: [{ item_id: undefined, material_name: "", material_type: "", size: "", material_description: "", quantity: 0, status: "", remarks: "" }] });
                                        }}
