                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6  pb-0'>
                    ...
                    <Card className={cn("w-full   shadow-sm hover:shadow-md transition-shadow flex flex-col")}>
                        <CardHeader className="flex flex-col gap-[0.5px]">
                            ...
                            <p className="text-xs text-muted-foreground mb-4">Add your Inventory details here</p>
                        ...
                        <CardContent className='flex flex-col gap-4'>
                            ...
                            {renderFormField("size", ({ field }) => (
                                <FormItem>
                                    <FormLabel>Item Size <span className="text-red-500">*</span></FormLabel>
                                    <FormControl><Input placeholder="Enter Item Size" className="resize-none" {...field} /></FormControl>
                                    <FormMessage />
                                </FormItem>
                            ))}
