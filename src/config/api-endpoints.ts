...
export const API_ENDPOINTS = {
    ...
    PURCHASE_ORDERS: {
        LIST: `${API_BASE_URL}/api/v1/purchase_orders`,
        CREATE: `${API_BASE_URL}/api/v1/purchase_orders`,
        UPDATE: (poId: number | string) => `${API_BASE_URL}/api/v1/purchase_orders/${poId}`,
        GET: (poId: number | string) => `${API_BASE_URL}/api/v1/purchase_orders/${poId}`,
        DELETE: (poId: number | string) => `${API_BASE_URL}/api/v1/purchase_orders/${poId}`,
    },
    INVENTORY: {
        LIST: `${API_BASE_URL}/api/v1/inventory`,
        CREATE: `${API_BASE_URL}/api/v1/inventory`,
        GET: (item_id: number | string) => `${API_BASE_URL}/api/v1/inventory/${item_id}`,
        UPDATE: (item_id: number | string) => `${API_BASE_URL}/api/v1/inventory/${item_id}`,
        DELETE: (item_id: number | string) => `${API_BASE_URL}/api/v1/inventory/${item_id}`,

    },
    QUOTATIONS: {
        LIST: `${API_BASE_URL}/api/v1/quotes`,
        CREATE: `${API_BASE_URL}/api/v1/quotes`,
        UPDATE: (quoteId: number | string) => `${API_BASE_URL}/api/v1/quotes/${quoteId}`,
        DELETE: (quoteId: number | string) => `${API_BASE_URL}/api/v1/quotes/${quoteId}`,
        GET: (quoteId: number | string) => `${API_BASE_URL}/api/v1/quotes/${quoteId}`,
        GET_CUSTOMER: (customerId: number | string) => `${API_BASE_URL}/api/v1/quotes/customer/${customerId}`,
    },
    JOB_TICKETS: {
        LIST: `${API_BASE_URL}/api/v1/jobs`,
        CREATE: `${API_BASE_URL}/api/v1/jobs`,
        GET: (jobId: number | string) => `${API_BASE_URL}/api/v1/jobs/${jobId}`,
        UPDATE: (jobId: number | string) => `${API_BASE_URL}/api/v1/jobs/${jobId}`,
        DELETE: (jobId: number | string) => `${API_BASE_URL}/api/v1/jobs/${jobId}`,

    },
    DISPATCH: {
        LIST: `${API_BASE_URL}/api/v1/dispatch`,
        CREATE: `${API_BASE_URL}/api/v1/dispatch`,
        UPDATE: (dispatch_id: number | string) => `${API_BASE_URL}/api/v1/dispatch/${dispatch_id}`,
        DELETE: (dispatch_id: number | string) => `${API_BASE_URL}/api/v1/dispatch/${dispatch_id}`,
        GET: (dispatch_id: number | string) => `${API_BASE_URL}/api/v1/dispatch/${dispatch_id}`,
    },
    CUSTOMERS: {
        LIST: `${API_BASE_URL}/api/v1/customers`,
        CREATE: `${API_BASE_URL}/api/v1/customers`,
        UPDATE: (customerId: number | string) => `${API_BASE_URL}/api/v1/customers/${customerId}`,
        DELETE: (customerId: number | string) => `${API_BASE_URL}/api/v1/customers/${customerId}`,
        GET: (customerId: number | string) => `${API_BASE_URL}/api/v1/customers/${customerId}`,
    },

    USER: {
        LIST: `${API_BASE_URL}/api/v1/auth/users`,
        CREATE: `${API_BASE_URL}/api/v1/auth/register`,
        UPDATE: (userID: number | string) => `${API_BASE_URL}/api/v1/auth/users/${userID}`,
        DELETE: (userID: number | string) => `${API_BASE_URL}/api/v1/auth/users/${userID}`,
        GET: (userID: number | string) => `${API_BASE_URL}/api/v1/auth/users/${userID}`,
    },
    ...
    DASHBOARD_KPI: {
        CREATE: `${API_BASE_URL}/api/v1/reports/dashboard/insights`,
    },
    REPORTS: {
        ADVANCED: `${API_BASE_URL}/api/v1/reports`,
        SUMMARY: `${API_BASE_URL}/api/v1/reports/summary`,
    },
