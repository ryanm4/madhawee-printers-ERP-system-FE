...
export const API_ENDPOINTS = {
  PURCHASE_ORDERS: {
    ...
    UPDATE: (poId: number | string) =>
      `${API_BASE_URL}/purchase_orders/${poId}`,
  ...
  INVENTORY: {
    ...
    UPDATE: (item_id: number | string) =>
      `${API_BASE_URL}/inventory/${item_id}`,
  ...
  QUOTATIONS: {
    ...
    GET_CUSTOMER: (customerId: number | string) =>
      `${API_BASE_URL}/quotes/customer/${customerId}`,
  },
  JOB_TICKETS: {
  ...
  DISPATCH: {
    ...
    UPDATE: (dispatch_id: number | string) =>
      `${API_BASE_URL}/dispatch/${dispatch_id}`,
    DELETE: (dispatch_id: number | string) =>
      `${API_BASE_URL}/dispatch/${dispatch_id}`,
    GET: (dispatch_id: number | string) =>
      `${API_BASE_URL}/dispatch/${dispatch_id}`,
  },
  CUSTOMERS: {
    LIST: `${API_BASE_URL}/customers`,
    CREATE: `${API_BASE_URL}/customers`,
    UPDATE: (customerId: number | string) =>
  ...
  RELATIVE: {
    PURCHASE_ORDERS: {
      ...
      UPDATE: (poId: number | string) =>
        `${NEXTJS_API_BASE}/purchase-orders/${poId}`,
      GET: (poId: number | string) =>
        `${NEXTJS_API_BASE}/purchase-orders/${poId}`,
      DELETE: (poId: number | string) =>
        `${NEXTJS_API_BASE}/purchase-orders/${poId}`,
    },
    INVENTORY: {
      ...
      GET: (item_id: number | string) =>
        `${NEXTJS_API_BASE}/inventory/${item_id}`,
      UPDATE: (item_id: number | string) =>
        `${NEXTJS_API_BASE}/inventory/${item_id}`,
      DELETE: (item_id: number | string) =>
        `${NEXTJS_API_BASE}/inventory/${item_id}`,
    ...
    QUOTATIONS: {
      ...
      UPDATE: (quoteId: number | string) =>
        `${NEXTJS_API_BASE}/quotes/${quoteId}`,
      DELETE: (quoteId: number | string) =>
        `${NEXTJS_API_BASE}/quotes/${quoteId}`,
      GET: (quoteId: number | string) => `${NEXTJS_API_BASE}/quotes/${quoteId}`,
      GET_CUSTOMER: (customerId: number | string) =>
        `${NEXTJS_API_BASE}/quotes/customer/${customerId}`,
    },
    JOB_TICKETS: {
    ...
    DISPATCH: {
      ...
      UPDATE: (dispatch_id: number | string) =>
        `${NEXTJS_API_BASE}/dispatch/${dispatch_id}`,
      DELETE: (dispatch_id: number | string) =>
        `${NEXTJS_API_BASE}/dispatch/${dispatch_id}`,
      GET: (dispatch_id: number | string) =>
        `${NEXTJS_API_BASE}/dispatch/${dispatch_id}`,
